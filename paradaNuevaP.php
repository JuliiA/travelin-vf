...
<head>
	<?php
		...
		$sqlParada1 = 'SELECT * FROM diarioDeViajero WHERE idDiario='.$idDiario;
	...
	//echo('nom= '.$nombre.' , direc= '.$direccion.', desc='.$descripcion.', idus='.$idUsuario.', tipoest='.$tipoEstablecimiento.', ciud='.$ciudad.', prov='.$provincia);
			...
			{
				$RsParada1 = mysqli_fetch_assoc($consultaParada1);
				$filas1 = mysqli_num_rows($consultaParada1);
				...
				if($filas1 == 0)
				{
					echo ('<html><head>
								<script type="text/javascript">
									...
									{
										alert("Antes de agregar paradas debe crear el diario.");
									}
								</script>
								</head><body>
					...
					{
						//$idEstableci = $RsParada1['idEstableci'];
						//$nombreE = $RsParada1['nombre'];
					}
			}
	?>
									...
									<div>
										<div id="contFormPublicacion" class="contFormulario1">
						   					<div id="agrupFormPublicacion" name="agrupFormPublicacion" class="contAgrupForm">
									            ...
									            <form class="form-horizontal" action="paradaNuevaC.php" method="post" enctype="multipart/form-data">
													<fieldset>
										                ...
										                <div class="form-group sep2">
															<div class="labelTitFormP">
																<label class="control-label labelTitForm"><h4>Crear Parada.</h4></label>
															</div>
														</div>
														...
														<div class="form-group sep2">
															...
															<div class="elementFormP">
																<input type="text" class="date-pick" id="fechaP" name="fechaP" value="" >
															</div>
														</div>
														...
														<div class="form-group sep2">
															...
															<div class="elementFormP">
																<input type="text" class="" id="nombreP" name="nombreP" value="" >
															</div>
														</div>
														...
														<div class="form-group sep2">
															...
															<div class="elementFormP">
																<textarea class="" cols="80" id="descripcionP" name="descripcionP" rows="10"></textarea>
															</div>
														</div>

														<br>
														<input type="hidden" id="idDiario" name="idDiario" value="<?php echo $idDiario; ?>">
														<!--
														<input type="hidden" id="idEstableci" name="idEstableci" value="">
														-->
														<div class="pull-centro">
															<input type="submit" id="crearP" name="crearP" value="Crear Parada">
