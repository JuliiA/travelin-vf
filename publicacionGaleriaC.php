...
/******* validar con un IF que todos los datos del nombre tenagn algo  *************/
				...
				$nuevoNombre = 'Img-'.$idUsuario.'-'.$idEstableci.'-'.$fecha.'-'.$aleatorio.'.'.$extencion[1];
				...
				{			
					...
					if(!(redimensionarI($origen1, 640, 480, $destino1, $tipo)))
					{
						...
						{
							//$valido = 1;
							$sql1 = 'INSERT INTO fotoestableci (nombre, descripcion, idEstableci) VALUES("'.$nuevoNombre.'", "", "'.$idEstableci.'")';
						...
						//{
							...
							echo ('<html><head>
									...
									<script>
										/*confirm_alert3();*/
										window.location="publicacionGaleriaP.php"
									</script>
									</body></html>');
						}
