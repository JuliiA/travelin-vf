...
<head>
	<?php
		...
		$idEstableci = $_GET['anuncio'];
		//$idUsuario = $_SESSION['idUsuario'];

		$sqlGaleria0 = 'SELECT nombre FROM establecimiento 
						WHERE idEstableci ='.$idEstableci.' AND idEstado = 2';
				...
				if($filas0 == 0)
				{
					echo ('<html><head>
								<script type="text/javascript">
									...
									{
										alert("No se encontró el anuncio, o no está activo..");
									}
								</script>
								</head><body>
						   					...
						   					<div id="agrupFormPublicacion" name="agrupFormPublicacion" class="contAgrupForm">
									            ...
									            <form class="form-horizontal" action="publicacionGaleriaC.php" method="post" enctype="multipart/form-data">
													<fieldset>
										                ...
										                <!-- Form Name -->
										                <!--<legend id="tituloForm"><?php echo $nombreE; ?>.</legend>-->
